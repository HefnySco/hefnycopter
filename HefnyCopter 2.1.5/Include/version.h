...
static const prog_char strVersionInfo[] = "HefnyCopter2 v1.2.0";
#define VERSION_16INT	0x0192
...
version 1.2.0
Function:
*	.Board KK2.1.5 compatible now.
*	.Auto PID Configuring for ACRO
UI:
*	.Switching between all flying modes using stick....no channel 5 is mandatory.
