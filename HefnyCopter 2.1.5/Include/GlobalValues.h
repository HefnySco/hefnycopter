...
#ifdef G_TUNE
#define FLYINGMODE_GTUNE			0b00001000
#define IS_FLYINGMODE_GTUNE			(nFlyingModes & FLYINGMODE_GTUNE)
#endif
...
// Mapping sensors to actual ADC pins.
...
typedef struct  
{
	...
	//uint8_t RESERVED[50];
	///////////////////// WARNING DONT: add variable between ... should be together for UART serialization
	...
	int8_t	MPU6050_LPF; // 0x06 = 5Hz, (5)10Hz, (4)20Hz, (3)42Hz, (2)98Hz, (1)188Hz LPF
	int8_t	MPU6050_Gyro_Range;
	int8_t	MPU6050_Acc_Range;
