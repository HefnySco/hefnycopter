...
#ifdef KK21
#define RX2_PITC_YAW_vect		PCINT0_vect
...
#ifdef KK21
#define RX2_PITCH_PIN			0b00100000
#define RX2_PITCH    			REGISTER_BIT(PINA,5)
#define RX2_PITCH_DIR   		REGISTER_BIT(DDRA,5)

#define RX2_YAW_PIN				0b00010000
#define RX2_YAW    				REGISTER_BIT(PINA,4)
#define RX2_YAW_DIR   			REGISTER_BIT(DDRA,4)
...
#define M2		  				REGISTER_BIT(PORTC,4)	// M3
#define M3		  				REGISTER_BIT(PORTC,2)	// M4
#define M4		  				REGISTER_BIT(PORTC,3)	// M2
