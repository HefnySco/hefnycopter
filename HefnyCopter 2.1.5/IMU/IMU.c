...
void IMU (void)
{
		...
		#ifdef G_TUNE
		if (IS_FLYINGMODE_GTUNE)
		{
		
			Calculate_ZEROPID(YAW_INDEX,CompGyroZ);
			Calculate_ZEROPID(PITCH_INDEX,CompGyroPitch);
			Calculate_ZEROPID(ROLL_INDEX,CompGyroRoll);
		}			
		#endif
