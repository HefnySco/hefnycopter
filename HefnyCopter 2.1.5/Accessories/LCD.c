...
void LCD_WriteRepeated(char ch, uint8_t len)
{
...
{
	LCD_WriteString(s);
	LCD_WriteRepeated(' ',len - strlen(s));
}
...
{
	LCD_WriteString_P(s);
	LCD_WriteRepeated(' ',len - strlen_P(s));
}
